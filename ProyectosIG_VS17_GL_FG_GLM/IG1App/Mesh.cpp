...
Mesh * Mesh::generaPiramide(GLdouble l, GLdouble h)
{
	...
	m->vertices[0] = dvec3(x, 0, x);
	m->vertices[1] = dvec3(x, 0, -x);
	m->vertices[2] = dvec3(0, h, 0);//
	m->vertices[3] = dvec3(x, 0, -x);
	m->vertices[4] = dvec3(-x, 0, -x);
	m->vertices[5] = dvec3(0, h, 0);//
	m->vertices[6] = dvec3(-x, 0, -x);
	m->vertices[7] = dvec3(-x, 0, x);
	m->vertices[8] = dvec3(0, h, 0);//
	m->vertices[9] = dvec3(-x, 0, x);
	m->vertices[10] = dvec3(x, 0, x);
	m->vertices[11] = dvec3(0, h, 0);//
...
Mesh * Mesh::generaPiramideTexCor(GLdouble l, GLdouble h)
{
	...
	m->textures[0] = dvec2(0, 0);
	m->textures[1] = dvec2(1, 0);
	m->textures[2] = dvec2(0.5, 0.5);
	m->textures[3] = dvec2(0, 0);
	m->textures[4] = dvec2(1, 0);
	m->textures[5] = dvec2(0.5, 0.5);
	m->textures[6] = dvec2(0, 0);
	m->textures[7] = dvec2(1, 0);
	m->textures[8] = dvec2(0.5, 0.5);
	m->textures[9] = dvec2(0, 0);
	m->textures[10] = dvec2(1, 0);
	m->textures[11] = dvec2(0.5, 0.5);
	return m;
}